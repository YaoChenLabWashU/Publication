...
global laserCOM laserWaveln state laserTuningTime
evalin('base','global laserCOM laserWaveln state laserTuningTime');
    ...
    while toc<laserTuningTime %  && str2double(msg)>0 % still tuning  
        ...
        if DEBUG
            ...
            case 1
                disp('Tuning...');
            case 2
                disp('Searching for modelock...');
            case 3
                disp('Laser recovery operation in progress...');
            end
        elseif tscode==0
            break;
        end
