function InsertDroppedFrames2(video_file, timestamp_file)
...
% This version specifies fps instead of reading it.
...
% fps=v.FrameRate;     % This does not read the right FrameRate
fps=25;
