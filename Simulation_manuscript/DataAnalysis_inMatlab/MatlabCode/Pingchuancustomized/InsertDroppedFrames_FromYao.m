function InsertDroppedFrames_FromYao(video_file, timestamp_file, interval_file, fps_read)
...
% str = str(1:end-1);
% str = strtrim(str);
str=readtable(timestamp_file, 'ReadVariableNames',false); %Read CSV file into a table
