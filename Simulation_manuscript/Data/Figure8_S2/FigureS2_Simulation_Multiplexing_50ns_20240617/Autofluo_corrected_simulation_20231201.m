...
% 9. the script for batch processing of simulation of autofluorescence
    ...
    for i=1:500 % Simulating 500 times
        ...
        AF=(randi(round(autofluo_number*0.1)))+round(autofluo_number*0.95); % Introduce 10% of fluctuation of the autofluorescence photon number
        [n_auto] = AutoFluo_sim_v2(autofluo_50ns, AF); % Simulation of autofluorescence based on autofluorescence distribution 'autofluo_corrected' and autofluorescence photon number 'AF'
...
%     TextMessage = [SimulationName, ': Simulation task ', num2str(SS), ' is done.'];
%     send_text_message('314-583-9402','verizon',Subject,TextMessage)